    ...
    <div className="flex min-h-screen page-enter">
      ...
      <div className="flex flex-col items-center justify-center flex-1 px-6" style={{ background: 'white' }}>
        <div style={{ width: '100%', maxWidth: 400 }}>
          ...
          <h1 style={{ fontFamily: "'Fraunces', serif", fontSize: 28, fontWeight: 600, letterSpacing: '-0.025em', color: '#1C1C1E', marginBottom: 4 }}>Forgot password?</h1>
          <p style={{ fontFamily: "'Plus Jakarta Sans'", fontSize: 14, color: '#6B7280', marginBottom: 28 }}>No worries, we'll send you reset instructions.</p>

          <div style={{ background: 'white', border: '1px solid #E5E3DF', borderRadius: 20, padding: 36, boxShadow: 'var(--shadow-xl)' }}>
            <form onSubmit={handleSubmit}>
              <div style={{ marginBottom: 16 }}>
                <label style={labelStyle}>Email</label>
                <input id="reset-email" type="email" placeholder="you@example.com" value={email} onChange={e => setEmail(e.target.value)} required style={inputStyle}
